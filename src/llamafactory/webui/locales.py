...
LOCALES = {
    ...
    "dataprocesstype": {
        "en": {
            "label": "Data process type",
            "info": "Data process type."
        },
        "zh": {
            "label": "数据处理类型",
            "info": "数据处理类型"
    ...
    "test_dir": {
        "en": {
            "label": "Testing data directory",
            "info": "Testing data directory."
        },
        "zh": {
            "label": "测试数据路径",
            "info": "测试数据路径"
    ...
    "distill_src": {
        "en": {
            "label": "Distill source data",
            "info": "Distill source data."
        },
        "zh": {
            "label": "蒸馏源数据",
            "info": "蒸馏源数据"
   ...
   "mount_dir": {
    ...
    "config_path": {
        "en": {
            "label": "Config path or file",
            "info": "Path or file to config saving arguments.",
        },
        "ru": {
